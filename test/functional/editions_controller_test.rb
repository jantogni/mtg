...
class EditionsControllerTest < ActionController::TestCase
  ...
  test "should create edition" do
    assert_difference('Edition.count') do
      post :create, edition: { code: @edition.code, date: @edition.date, is_promo: @edition.is_promo, name: @edition.name }
    end
  ...
  test "should update edition" do
    put :update, id: @edition, edition: { code: @edition.code, date: @edition.date, is_promo: @edition.is_promo, name: @edition.name }
    assert_redirected_to edition_path(assigns(:edition))
  end
